...
import { Plus, ZoomIn, ZoomOut, Maximize, Download, Share2, Copy, Trash2, RotateCw, Layers, Grid, Lock, Move, ArrowLeftRight, ArrowUpDown, PanelLeftOpen, PanelLeftClose, Minimize, Palette, MoreHorizontal, Settings, ScreenShare as Fullscreen } from 'lucide-react';
